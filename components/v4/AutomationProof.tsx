        ...
        <div className="v4-causal">
          <figure className="v4-causal__side v4-causal__side--when">
            ...
            <div className="v4-product-window">
              ...
              <div className="v4-product-window__viewport v4-causal__viewport">
                <img data-testid="v4-automation-image" src="/product-v4/automations.webp" width="2048" height="1407" alt="Tela real do Loomie com gatilhos administrativos demonstrativos e inativos" />
              </div>
            </div>
          </figure>
          ...
          <figure className="v4-causal__side v4-causal__side--then">
            ...
            <div className="v4-product-window">
              ...
              <div className="v4-product-window__viewport v4-causal__viewport">
                <img data-testid="v4-task-image" src="/product-v4/tasks.webp" width="2048" height="1407" alt="Tela real do Loomie com uma tarefa administrativa fictícia no ambiente demonstrativo" />
              </div>
            </div>
          </figure>
        </div>
