        ...
        <figure className="v4-dashboard__stage">
          <div className="v4-product-window">
            ...
            <div className="v4-product-window__viewport">
              <img data-testid="v4-dashboard-image" src="/product-v4/dashboard.webp" width="2048" height="1422" alt="Dashboard real do ambiente demonstrativo do Loomie com dados fictícios da operação" />
